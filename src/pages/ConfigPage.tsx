...
const ConfigPage: React.FC = () => {
    ...
    return (
        <div className="p-4 md:p-6">
            <h1 className="text-2xl font-bold mb-6 text-gray-800">Gestión de Datos</h1>
            ...
            <div className="bg-white shadow-md rounded-lg p-6 mb-8">
                <h2 className="text-xl font-semibold mb-4 text-gray-700 border-b pb-2">Crear Copia de Seguridad</h2>
            ...
            <div className="bg-white shadow-md rounded-lg p-6">
                <h2 className="text-xl font-semibold mb-4 text-gray-700 border-b pb-2">Restaurar desde Copia de Seguridad</h2>
                {isRestoreDisabled ? (
                    ...
                    <>
                        <p className="text-gray-600 mb-4">
                            ...
                            <span className="font-bold text-red-600"> Advertencia:</span> Esta acción sobreescribirá todos los datos actuales.
                        </p>
